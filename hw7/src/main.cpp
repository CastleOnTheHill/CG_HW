...
int main()
{
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "HW", NULL, NULL);
	if (window == NULL)
	{
	...
	// load textures
	// -------------
	unsigned int brickTexture = loadTexture("bricks2.jpg");
	unsigned int boxTexture = loadTexture("container2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//simpleDepthShader.setInt("selector", assignment_num);
		...
		ImGui::SliderInt("Shininess", &Shininess, 32, 128);
		ImGui::End();
		ImGui::Render();
